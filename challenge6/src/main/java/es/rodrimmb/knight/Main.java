...
public class Main {
    ...
    private static final List<String> COMMANDS_2 = asList("2u1r", "2l1u", "2l1u", "2u1l", "2u1l", "1l2d", "1l2u",
    ...
    public static void main(String[] args) throws Exception {
        ...
        Board newBoard = null;
        for (final String command : COMMANDS_2) {
            newBoard = oldBoard.updateBoard(command, knightClient.sendMessage(command), oldBoard);
